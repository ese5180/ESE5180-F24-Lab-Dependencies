...
void loop()
{
  ...
  // uint8_t toSend[64] = "Hi there!";
  sprintf(toSend, "Hi this is team %d, my counter is: %d",TEAM_NUMBER, packetCounter++);
  SerialUSB.println(strlen(toSend));
  SerialUSB.print("Message to send: "); 
